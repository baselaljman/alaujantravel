        ...
        <div className="px-6 py-8 sm:px-12 sm:py-10 text-slate-700 leading-relaxed space-y-8">
          ...
          <div className="bg-emerald-50/50 rounded-xl p-5 border border-emerald-100">
            ...
            <p className="text-slate-600 mb-3">
              يتطلب تطبيق العوجان الوصول إلى بيانات الموقع الجغرافي الخاصة بكم لتقديم الخدمات الأساسية التالية:
            </p>
            <ul className="list-disc list-inside space-y-2 text-slate-600 mr-4">
              <li>
                <strong>تحديد مكان الركوب:</strong> لمساعدة الركاب في معرفة أقرب نقطة تجمع أو حافلة، وإرشاد السائق إلى مكان تواجد الراكب بدقة.
              </li>
              <li>
                <strong>تتبع الحافلة (للسائقين):</strong> يحتاج التطبيق إلى تتبع موقع السائق لمشاركته مع الركاب المنتظرين لتمكينهم من معرفة الوقت المتبقي لوصول الحافلة.
              </li>
              <li>
                <strong>العمل في الخلفية (Background Location):</strong> لتسهيل تتبع الحافلات بانتظام حتى في حال إغلاق الشاشة أو تشغيل تطبيق آخر، وتزويد الركاب بتحديثات حية ومستمرة لموقع الرحلة. (بإمكانكم إلغاء أو تخصيص هذا الإذن من إعدادات الهاتف في أي وقت).
              </li>
            </ul>
          </div>
